 ...
 *     That is bad. The worse is some Tamil letters having more than one sequence of code points. This feature allows the matcher to treat all the possible sequence same.
