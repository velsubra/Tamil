 ...
 * @author velsubra
 */
public final class EthirmarraiththozhirrPeyar extends VinaiyadiDerivative implements IEthirmarrai, IPeyarchchol{
    public EthirmarraiththozhirrPeyar(TamilWord word, Vinaiyadi vinaiyadi) {
