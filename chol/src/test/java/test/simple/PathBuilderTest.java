...
public class PathBuilderTest {
    ...
    public void test00Simple() throws Exception {
        ...
        builder.multiplyPathsWithNodes(Arrays.asList(new String[]{"e","f", "g"}));
    ...
    public void test0Simple() throws Exception {
        PathBuilder<String> builder = new PathBuilder<String>();
        builder.multiplyPathsWithNodes(Arrays.asList(new String[]{"நிரை", "மலர்", "கலாம்", "அடி"}));
        builder.multiplyPathsWithNodes(Arrays.asList(new String[]{"நேர்", "மா", "அ", "மண்"}));
        List<List<String>>  paths = builder.getPaths();
        System.out.println(paths);
    ...
    public void test3Simple() throws Exception {
        PathBuilder<String> builder = new PathBuilder<String>();
        builder.appendNodeToAllPaths("a");
        builder.multiplyPathsWithNodes(TamilUtils.parseString("b,c,d"));
        List<List<String>>  paths = builder.getPaths();
        System.out.println(paths);
    ...
    public void test5Simple() throws Exception {
        ...
        builder.multiplyPathsWithNodes(TamilUtils.parseString("b,c,d"));
        builder.multiplyPathsWithNodes(TamilUtils.parseString("d,e"));
        List<List<String>>  paths = builder.getPaths();
        System.out.println(paths);
    ...
    public void test6Simple() throws Exception {
        ...
        builder.multiplyPathsWithNodes(TamilUtils.parseString("b,c,d"));
        builder.multiplyPathsWithNodes(TamilUtils.parseString("d,e"));
        builder.multiplyPathsWithNodes(TamilUtils.parseString("f"));
        List<List<String>>  paths = builder.getPaths();
        System.out.println(paths);
    ...
    public void test7Simple() throws Exception {
        ...
        builder.multiplyPathsWithNodes(TamilUtils.parseString("b,c,d"));
        builder.multiplyPathsWithNodes(TamilUtils.parseString("d,e"));
        builder.multiplyPathsWithNodes(TamilUtils.parseString("f,g"));
        builder.multiplyPathsWithNodes(TamilUtils.parseString("h"));
        builder.multiplyPathsWithNodes(TamilUtils.parseString("b,a"));
        List<List<String>>  paths = builder.getPaths();
        System.out.println(paths);
