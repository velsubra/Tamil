...
//        }
    ...
    public String getVigaaram(boolean  transitive, String tense, String paal) {
        String name = null;
        if (transitive) {
            name = DefinitionFactory.VINAIMUTRU_BASE ;

        } else {
            name = DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE;
        }
        name += ".vigaaram";
        if (tense != null) {
    ...
    public void setIdaiNilai(String ch, String tense, boolean transitive) {
        if (transitive) {
            map.put(DefinitionFactory.VINAIMUTRU_BASE + ".idainilai." + tense, ch == null ? "" : ch.toString());
        } else {
            map.put(DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE + ".idainilai." + tense, ch == null ? "" : ch.toString());
        }
    }

    public void setSanthi(TamilCharacter ch, String tense, boolean transitive) {
        if (transitive) {
            map.put(DefinitionFactory.VINAIMUTRU_BASE + ".santhi." + tense, ch == null ? "" : ch.toString());
        } else {
            map.put(DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE + ".santhi." + tense, ch == null ? "" : ch.toString());
        }
    }

    public void setSaariyai(TamilCharacter ch, String tense, boolean transitive) {
        if (transitive) {
            map.put(DefinitionFactory.VINAIMUTRU_BASE + ".saariyai." + tense, ch == null ? "" : ch.toString());
        } else {
            map.put(DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE + ".saariyai." + tense, ch == null ? "" : ch.toString());
        }
    }
    ...
    public void setSanthiOntran(TamilCharacter ch, String tense, boolean transitive) {
        if (transitive) {
            map.put(DefinitionFactory.VINAIMUTRU_BASE + ".santhi." + tense + ".thu", ch == null ? "" : ch.toString());
        } else {
            map.put(DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE + ".santhi." + tense + ".thu", ch == null ? "" : ch.toString());
        }
    }

    public void setSaariyaiOntran(TamilCharacter ch, String tense, boolean transitive) {
        if (transitive) {
            map.put(DefinitionFactory.VINAIMUTRU_BASE + ".saariyai." + tense + ".thu", ch == null ? "" : ch.toString());
        } else {
            map.put(DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE + ".saariyai." + tense + ".thu", ch == null ? "" : ch.toString());
        }
    }

    public void setSanthiPalavin(TamilCharacter ch, String tense, boolean transitive) {
        if (transitive) {
            map.put(DefinitionFactory.VINAIMUTRU_BASE + ".santhi." + tense + ".a", ch == null ? "" : ch.toString());
        } else {
            map.put(DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE + ".santhi." + tense + ".a", ch == null ? "" : ch.toString());
        }
    }

    public void setSaariyaiPalavin(TamilCharacter ch, String tense, boolean transitive) {
        if (transitive) {
            map.put(DefinitionFactory.VINAIMUTRU_BASE + ".saariyai." + tense + ".a", ch == null ? "" : ch.toString());
        } else {
            map.put(DefinitionFactory.VINAIMUTRU_BASE_INTRANSITIVE + ".saariyai." + tense + ".a", ch == null ? "" : ch.toString());
        }
    }
