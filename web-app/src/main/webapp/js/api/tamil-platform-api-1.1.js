...
//                console.log("input:" + word + " output:" + ret);
    ...
    this.createPersistenceManager = function () {
        ...
        this.createNounManager = function () {
            ...
            this.list_noun_tree_url = this.context + "/api/noun/question-tree/list/?idsection=";
        ...
        /**
         * lists all the nodes with id that contains the given part
         * @param idsection the node id segment
         * @param callback the call-back to post the results
         * @return  {json} - The result looks as below.
         * See the method for describe for output example
         */
        this.list = function (idsection, callback) {
            idsection = typeof idsection !== 'undefined' ? idsection.trim() : "definition.type";
            jQuery.ajax({
                type: 'get',
                url: this.list_noun_tree_url + idsection,
